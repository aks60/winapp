...
//        };
    ...
    private void initComponents() {
        ...
        btnConstructiv.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c088.gif"))); // NOI18N
        ...
        btnConstructiv.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c001.gif"))); // NOI18N
        ...
        btnFindSystree.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c089.gif"))); // NOI18N
        ...
        btnFindSystree.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c001.gif"))); // NOI18N
        ...
        btnSet.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c033.gif"))); // NOI18N
    ...
    private void btnFindSystree(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindSystree
        ...
        if (pathList.size() != 0) {
            ...
            Object result = JOptionPane.showInputDialog(Furniturs.this, "Фурнитура в ветках систем профилей", "Ветки систем профилей",
                    JOptionPane.QUESTION_MESSAGE, new ImageIcon(getClass().getResource("/img24/c066.gif")), pathArr, pathArr[0]);
