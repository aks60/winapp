...
public class Elements extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnFindArtikl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c088.gif"))); // NOI18N
        ...
        btnFindArtikl.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c001.gif"))); // NOI18N
    ...
    private void btnFindSystree(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindSystree
        ...
        if (pathList.size() != 0) {
            ...
            Object result = JOptionPane.showInputDialog(Elements.this, "Артикул в системе профилей", "Сообщение", JOptionPane.QUESTION_MESSAGE,
                    new ImageIcon(getClass().getResource("/img24/c066.gif")), pathList.toArray(), pathList.toArray()[0]);
