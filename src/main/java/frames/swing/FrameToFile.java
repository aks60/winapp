...
public class FrameToFile extends javax.swing.Timer implements ActionListener {
    ...
    public void initListener() {
        ...
        btn.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                stop();
                btn.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c001.gif")));
            }
        });
    }
    ...
    public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            btn.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c036.gif")));
