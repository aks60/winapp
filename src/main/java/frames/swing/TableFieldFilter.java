...
public class TableFieldFilter extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btn1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c054.gif"))); // NOI18N
        ...
        btn2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img16/b041.gif"))); // NOI18N
        ...
        try {
            if (table != null) {
                if (txtFilter.getText().length() == 0) {
                    ...
                    btn2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img16/b064.gif")));
    ...
    private void btn1ActiPerf(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActiPerf
        try {
            if (search == true) {
                btn1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c054.gif")));
                search = !search;
                txtCaretUpdate(null);
            } else {
                btn1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img24/c043.gif")));
                search = !search;
