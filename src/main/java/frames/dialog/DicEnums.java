...
public class DicEnums extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        north.setPreferredSize(new java.awt.Dimension(360, 29));
        ...
        south.setPreferredSize(new java.awt.Dimension(360, 20));
    ...
    private void btnChoice(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChoice
        ...
        record.add(enam[UGui.getIndexRec(tab1)].numb());
        record.add(enam[UGui.getIndexRec(tab1)].text());
