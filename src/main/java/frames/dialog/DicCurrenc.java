...
public class DicCurrenc extends javax.swing.JDialog {
    ...
    public DicCurrenc(Frame parent, ListenerRecord listener) {
        super(parent, true);
        initComponents();
        initElements();
        loadingData();
    ...
    public DicCurrenc(Frame parent, ListenerRecord listener, int id) {
        super(parent, true);
        initComponents();
        this.ID = id;
        initElements();
    ...
    private void initComponents() {
        ...
        addWindowListener(new java.awt.event.WindowAdapter() {
            public void windowClosed(java.awt.event.WindowEvent evt) {
                DicCurrenc.this.windowClosed(evt);
            }
        });
        ...
        tab1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                DicCurrenc.this.mouseClicked(evt);
            }
        });
