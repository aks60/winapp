...
public class UColor {
    ...
    public UColor() {
        if (this.icon[0] == null) {
            ImageIcon icon[] = {
                new ImageIcon(getClass().getResource("/img16/b000.gif")),
                new ImageIcon(getClass().getResource("/img16/b001.gif")),
                new ImageIcon(getClass().getResource("/img16/b002.gif")),
                new ImageIcon(getClass().getResource("/img16/b003.gif")),
                new ImageIcon(getClass().getResource("/img16/b004.gif")),
                new ImageIcon(getClass().getResource("/img16/b005.gif"))};
            this.icon = icon;
        }
        if (this.icon2[0] == null) {
            ImageIcon icon[] = {
                new ImageIcon(getClass().getResource("/img16/b070.gif")),
                new ImageIcon(getClass().getResource("/img16/b071.gif")),
                new ImageIcon(getClass().getResource("/img16/b072.gif")),
                new ImageIcon(getClass().getResource("/img16/b073.gif")),
                new ImageIcon(getClass().getResource("/img16/b074.gif")),
                new ImageIcon(getClass().getResource("/img16/b075.gif"))};
            this.icon2 = icon;
        }
    }
