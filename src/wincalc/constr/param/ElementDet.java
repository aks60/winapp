        ...
        for (Record paramRec : paramList) {
            switch (paramRec.getInt(GRUP)) {
                ...
                case 34005:  //Коды основной текстуры контейнера
                    ...
                    if (compareInt(paramRec.getStr(TEXT), m1) == false) {
                        return false;
                    }
                    break;
                ...
                case 34006:  //Коды внутр. текстуры контейнера 
                    ...
                    if (compareInt(paramRec.getStr(TEXT), m2) == false) {
                        return false;
                    }
                    break;
                ...
                case 34007:  //Коды внешн. текстуры контейнера     
                    ...
                    if (compareInt(paramRec.getStr(TEXT), m3) == false) {
                        return false;
                    }
                    break;
                ...
                case 33066:  //Если номер стороны в контуре
                    if ("1".equals(paramRec.getStr(TEXT)) == true && LayoutArea.BOTTOM != elemSimple.layout()) {
                        return false;
                    } else if ("2".equals(paramRec.getStr(TEXT)) == true && LayoutArea.RIGHT != elemSimple.layout()) {
                        return false;
                    } else if ("3".equals(paramRec.getStr(TEXT)) == true && LayoutArea.TOP != elemSimple.layout()) {
                        return false;
                    } else if ("4".equals(paramRec.getStr(TEXT)) == true && LayoutArea.LEFT != elemSimple.layout()) {
                        return false;
                    }
                    break;
