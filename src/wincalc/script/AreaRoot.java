...
public class AreaRoot extends AreaElem {
    ...
    protected Float heightAdd = null;  //меньшая высота, мм (по аналогии с ПС-4). Для прямоугольного изделия = height.
    ...
    public AreaRoot(String id, LayoutArea layoutArea, TypeElem elemType, float width, float height, float heightAdd, int color1, int color2, int color3, String paramJson) {
        super.id = id;
