        ...
        for (Record rec : tableList) {
            ...
            try {
                ...
                case 25001:  //Форма контура 
                    if (TypeElem.STVORKA == elem5e.type() && "прямоугольная".equals(rec.getStr(TEXT)) == false) {
                        return false;
                    }
                    break;
                ...
                case 25070:  //Если высота ручки     
                    ...
                    if ("по середине".equals(str) == true && rec.getStr(TEXT).equals("не константная") == false
                            || "константная".equals(str) == true && rec.getStr(TEXT).equals("константная") == false) {
                        return false;
                    }
                    break;
