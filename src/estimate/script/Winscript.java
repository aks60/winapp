...
public class Winscript {
    ...
    public static String testPs4(Integer project, Integer nuni) {
        ...
        if (project == 601001) {
            ...
            AreaElem area5 = (AreaElem) area3.add(new AreaElem(10, LayoutArea.VERT, TypeElem.STVORKA, "{'typeOpen':3, 'sysfurnID':860}"));
    ...
    public static String testPs3(Integer project, Integer nuni) {
        ...
        if (project == 601001) {
            ...
            AreaElem area4 = (AreaElem) area2.add(new AreaElem(9, LayoutArea.VERT, TypeElem.STVORKA, "{'typeOpen':3}"));
            AreaElem area5 = (AreaElem) area3.add(new AreaElem(10, LayoutArea.VERT, TypeElem.STVORKA, "{'typeOpen':4}"));
