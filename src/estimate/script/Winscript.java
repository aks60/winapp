...
public class Winscript {
    ...
    public static String test(Integer project, Integer nuni) {
        ...
        if (project == 601001) {            
            ...
            AreaElem area4 = (AreaElem) area2.add(new AreaElem(9, LayoutArea.VERT, TypeElem.STVORKA, "{'typeOpen':3, 'sysfurnID':861}"));
            AreaElem area5 = (AreaElem) area3.add(new AreaElem(10, LayoutArea.VERT, TypeElem.STVORKA, "{'typeOpen':3, 'sysfurnID':861}"));
            ...
            AreaElem area14 = (AreaElem) area11.add(new AreaElem(14, LayoutArea.VERT, TypeElem.STVORKA, "{'typeOpen':3, 'sysfurnID':701}"));
