...
public class Winscript {
    ...
    public static String testPs4(Integer project, Integer nuni) {
        ...
        if (project == 601001) {
            ...
            rootArea = new AreaRoot(1, LayoutArea.HORIZ, TypeElem.RECTANGL, 1300, 1400, 1400, 1009, 1009, 1009, "{'artikleID':1120, 'ioknaParam':[[-862071,295],[-862065,314],[-862062,325],[-862131,17],[-862097,195],[-862060,335]]}");
            rootArea.setParam(project.toString(), 371, "KBE\\KBE Эксперт\\1 ОКНА\\Открывание внутрь (ств. Z 77)");
            rootArea.add(new Element(2, TypeElem.FRAME_SIDE, LayoutArea.LEFT));
            rootArea.add(new Element(3, TypeElem.FRAME_SIDE, LayoutArea.RIGHT));
            rootArea.add(new Element(4, TypeElem.FRAME_SIDE, LayoutArea.TOP));
            ...
            AreaElem area4 = (AreaElem) area2.add(new AreaElem(9, LayoutArea.VERT, TypeElem.STVORKA, "{'artikleID':1121, 'typeOpen':1,'sysfurnID':2335, 'ioknaParam': [[-862107,826],[-862106,830]]}"));
            AreaElem area5 = (AreaElem) area3.add(new AreaElem(10, LayoutArea.VERT, TypeElem.STVORKA, "{'artikleID':1121, 'typeOpen':4,'sysfurnID':2916, 'ioknaParam': [[-862107,184],[-862106,186]]}"));
    ...
    public static String testPs3(Integer project, Integer nuni) {
        ...
        if (project == 601001) {
            ...
            rootArea.setParam(project.toString(), 28, "СИАЛ\\КП40\\Окна");
            rootArea.add(new Element(2, TypeElem.FRAME_SIDE, LayoutArea.LEFT));
            rootArea.add(new Element(3, TypeElem.FRAME_SIDE, LayoutArea.RIGHT));
            rootArea.add(new Element(4, TypeElem.FRAME_SIDE, LayoutArea.TOP));
            rootArea.add(new Element(5, TypeElem.FRAME_SIDE, LayoutArea.BOTTOM));
