...
public enum UseColcalc implements Enam {
    ...
    P11(11, "Профиль"), // 3003 - по профилю
    P21(21, "Заполнение"), //799 - по заполнению (зависимая?), 4095 - по заполнению
    P31(31, "Основная"),  //273 - на основе изделия, 801 - по основе изделия, 
    ...
    P50(50, "Параметр"), // 3145 - по параметру (основа), 1092 - по параметру (внутр.), 3276 - по параметру (внешн.)
