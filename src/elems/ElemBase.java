...
//        }
    ...
    protected void resposeParamJson() {
        LinkedList<ElemBase> elList = root.getElemList(eTypeElem.GLASS, eTypeElem.FULLSTVORKA);
        elList.add(root);
        for (ElemBase el : elList) {
            HashMap<Integer, Object[]> map = (HashMap) el.getHmParamJson().get(eParamJson.pro4Params2);
...
//        sp.elemType = String.valueOf(this.getTypeElem().value);
     ...
     * Типы профилей
     */
    public abstract eTypeProfile getTypeProfile();
...
//    }
    ...
    public LinkedList<ElemBase> getAreaElemList() {
        ...
        for (ElemBase elemBase : owner.getChildList()) {
            if (eTypeElem.AREA == elemBase.getTypeElem() || eTypeElem.IMPOST == elemBase.getTypeElem()) {
    ...
    public void setHmParamJson(HashMap<eParamJson, Object> hmParamJson) {
        this.hmParamJson = hmParamJson;
    }

    public HashMap<eParamJson, Object> getHmParamJson() {
        return hmParamJson;
    }
