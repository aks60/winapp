...
public class AreaArch extends AreaSimple {
    ...
    public AreaArch(IWindows iwin, String id, eLayoutArea layout, float width, float height, int colorBase, int colorInterna, int colorExternal, String paramJson) throws Exception {
...
//
//        if (eLayoutArea.ARCH == elemFrame.side) {
