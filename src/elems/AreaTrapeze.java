...
public class AreaTrapeze extends AreaSimple {
    ...
    public AreaTrapeze(IWindows iwin, String id, eLayoutArea layout, float width, float height, int colorBase, int colorInterna, int colorExternal, String paramJson) {
...
//    public void setSpecifElement(ElemFrame elemFrame, Sysproa sysproaRec) {
        ...
        /*if(eLayoutArea.RIGHT == elemFrame.getLayout()) {
