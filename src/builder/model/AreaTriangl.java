...
public class AreaTriangl extends AreaSimple {
    ...
    public AreaTriangl(Wincalc iwin, AreaSimple owner, float id, Type type, Layout layout, float width, float height, int color1, int color2, int color3, String param) {
