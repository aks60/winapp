                ...
                if (listCom.get(index).id() == id()) {
                    ...
                    if (owner.equals(root()) && owner.layout() == Layout.VERT) {
                        if (side == Layout.TOP) {
                            ...
                            return (index == listCom.size() - 1) ? mapJoin.get(side) : listCom.get(index + 1);
                        } else {
                        ...
                        if (owner.layout() == Layout.VERT) {
                            if (side == Layout.TOP) {
                                return (index == 0) ? owner.getAdjoinedElem(side) : listCom.get(index - 1);
                            } else if (side == Layout.BOTT) {
                                return (index == listCom.size() - 1) ? owner.getAdjoinedElem(side) : listCom.get(index + 1);
                            } else {
                                return owner.getAdjoinedElem(side);
                            }
                        } else {
                            if (side == Layout.LEFT) {
                                return (index == 0) ? owner.getAdjoinedElem(side) : listCom.get(index - 1);
...
/*
    public IElem5e getAdjoinedElem(Layout layout) {
        try {
            ...
            for (int index = 0; index < listElem.size(); ++index) {
                ...
                if (owner.equals(root()) && owner.layout() == Layout.VERT) {
                    ...
                    if (owner.layout() == Layout.VERT) {
                        if (layout == Layout.TOP) {
                            return (index == 0) ? owner.getAdjoinedElem(layout) : listElem.get(index - 1);
                        } else if (layout == Layout.BOTT) {
                            return (index == listElem.size() - 1) ? owner.getAdjoinedElem(layout) : listElem.get(index + 1);
                        } else {
                            return owner.getAdjoinedElem(layout);
                        }
                    } else {
                        if (layout == Layout.LEFT) {
                            return (index == 0) ? owner.getAdjoinedElem(layout) : listElem.get(index - 1);
