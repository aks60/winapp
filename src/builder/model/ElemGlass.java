...
//            ElemSimple insideLeft2 = joinFlat(Layout.LEFT), insideTop2 = joinFlat(Layout.TOP), insideBott2 = joinFlat(Layout.BOTT), insideRight2 = joinFlat(Layout.RIGHT);
            ElemSimple insideLeft = joinFlatUp(Layout.LEFT), insideTop = joinFlatUp(Layout.TOP), insideBott = joinFlatUp(Layout.BOTT), insideRight = joinFlatUp(Layout.RIGHT);
//            if (id() == 11) {
...
//                int mmm = 0;
//            } 
            ElemSimple ob9 = joinFlatUp(Layout.TOP);
            if (iwin.syssizeRec.getInt(eSyssize.id) == -1) {
