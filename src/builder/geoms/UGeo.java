...
public class UGeo {
    ...
    public static Area[] split(Area a, Point2D p0, Point2D p1) {
        ...
        try {
            ...
            System.out.println("Ошибка:Geocalc.split() " + e);
        }
    ...
    public static Point2D[] cross(final Shape poly, final Line2D.Double line) { //throws Exception {
