...
import builder.gson.model.Vidnal;
import builder.gson.model.Sial3;
import builder.gson.model.Krauss;
import builder.gson.model.Bimax;
...
public class Winscript {
    ...
    public static List<Integer> models() {
        ...
        if (base_name.toLowerCase().contains("sial3.fdb")) {
            ...
            return Arrays.asList(601001, 601002, 601003, 601004, 601005, 601006, 601007, 601008, 601009, 601010, 700027, 604004, 604005, 604006, 604007, 604008, 604009, 604010);
