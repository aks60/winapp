...
public final class Sial3 {
    ...
    public static String script(Integer prj, boolean model) {
        ...
        if (prj == 601001) {
            ...
            rootGson.addElem(new GsonElem(Type.GLASS, "{'artglasID':285}"));
            ...
            rootGson.addElem(new GsonElem(Type.FRAME_SIDE, Layout.TOP));
            rootGson.addElem(new GsonElem(Type.FRAME_SIDE, Layout.BOTT));
            rootGson.addArea(new GsonElem(Layout.VERT, Type.STVORKA, "{'typeOpen':2}"))
            ...
            rootGson.addElem(new GsonElem(Type.FRAME_SIDE, Layout.TOP));
            rootGson.addElem(new GsonElem(Type.FRAME_SIDE, Layout.BOTT));
            rootGson.addArea(new GsonElem(Layout.HORIZ, Type.AREA, 1200 / 2))
            ...
            rootGson.addElem(new GsonElem(Type.FRAME_SIDE, Layout.TOP));
            rootGson.addElem(new GsonElem(Type.FRAME_SIDE, Layout.BOTT));
            rootGson.addArea(new GsonElem(Layout.HORIZ, Type.AREA, 670))
            ...
            area3.addArea(new GsonElem(Layout.VERT, Type.AREA, 1220))
                    .addElem(new GsonElem(Type.GLASS, "{'artglasID':286}"));
