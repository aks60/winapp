        ...
        try {
            ...
            if (spcRec.artiklRec.get(eArtikl.id) != null
                ...
                if ((spcRec.artiklRec.getInt(eArtikl.level1) * 100 + spcRec.artiklRec.getInt(eArtikl.level2)) == rulecalcRec.getInt(eRulecalc.type)) {
                    if (UCom.containsColorJust(rulecalcRec.getStr(eRulecalc.color1), spcRec.colorID1) == true
                            && UCom.containsColorJust(rulecalcRec.getStr(eRulecalc.color2), spcRec.colorID2) == true
                            && UCom.containsColorJust(rulecalcRec.getStr(eRulecalc.color3), spcRec.colorID3) == true) {
