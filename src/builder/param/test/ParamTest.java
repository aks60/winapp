...
public class ParamTest {
    ...
    private void iwin2() {
        ...
        iwin_2.build(builder.script.GsonScript.testJson(601004));
    ...
    private void iwin3() {
        ...
        iwin_3.build(builder.script.GsonScript.testJson(604005));
    ...
    private void iwin4() {
        ...
        iwin_4.build(builder.script.GsonScript.testJson(700027));
