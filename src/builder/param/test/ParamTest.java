...
public class ParamTest {
    ...
    private void iwin2() {
        ...
        iwin_2.build(builder.script.Winscript2.test(601004, true));
    ...
    private void iwin3() {
        ...
        iwin_3.build(builder.script.Winscript2.test(604005, true));
    ...
    private void iwin4() {
        ...
        iwin_4.build(builder.script.Winscript2.test(700027, true));
