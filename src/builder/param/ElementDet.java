        ...
        try {
            switch (grup) {
                ...
                case 34000: //Для технологического кода контейнера 
                    if (!UParIs.is_STRING_XX000(rec.getStr(TEXT), elem5e)) {
                        return false;
                    }
                    break;
                case 33001:  //Если признак состава 
                case 34001:  //Если признак состава 
                    if (UParIs.is_11001_11002_12001_12002_13001_14001_15001_33001_34001(rec.getStr(TEXT), elem5e) == false) {
                        return false;
                    }
                    break;
                ...
                case 34011: //Толщина внешнего/внутреннего заполнения, мм
                    List<IElem5e> glassList = UParIs.getGlassDepth(elem5e);
                ...
                case 40017: //Код системы содержит строку                 
                    if (UParIs.is_13017_14017_24017_25017_31017_33017_34017_37017_38017(rec.getStr(TEXT), winc) == false) {
                        return false;
                    }
                    break;
                ...
                case 34066:  //Если номер стороны в контуре    
                    if (!UParIs.is_INT_33066_34066(rec.getStr(TEXT), elem5e)) {
                        return false;
                    }
                    break;
                ...
                case 34071:  //Контейнер типа
                    if (UParIs.is_1005x6_2005x6_3005_4005_11005_12005_31050_33071_34071(rec.getStr(TEXT), elem5e) == false) {
                        return false;
                    }
                    break;
                ...
                case 39002:  //Номер стороны 
                    if (UParIs.is_38010_39002(elem5e, rec.getStr(TEXT)) == false) {
                        return false;
                    }
                    break;
                ...
                case 40037:  //Название фурнитуры содержит 
                    if (UParIs.is_31037_38037_39037_40037(elem5e, rec.getStr(TEXT)) == false) {
                        return false;
                    }
                    break;
                case 38039:  //Для типа открывания 
                case 39039:  //Для типа открывания 
                    if (UParIs.is_1039_38039_39039(elem5e, rec.getStr(TEXT)) == false) {
                        return false;
                    }
                    break;
