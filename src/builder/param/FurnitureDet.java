        ...
        try {
            switch (grup) {
                ...
                case 25005:  //Коды текстуры створки 
                    if (areaStv.frames().entrySet().stream().filter(el -> UCom.containsColorJust(rec.getStr(TEXT), el.getValue().colorID1()) == true).findFirst().orElse(null) == null) {
                        return false;
                    }
                    break;
                ...
                case 25068:  //Коды внутр. текстуры изделия 
                    if (UCom.containsColorJust(rec.getStr(TEXT), winc.colorID2) == false) {
                        return false;
                    }
                    break;
                case 24069:  //Коды внешн. текстуры изделия 
                case 25069:  //Коды внешн. текстуры изделия     
                    if (UCom.containsColorJust(rec.getStr(TEXT), winc.colorID3) == false) {
                        return false;
                    }
                    break;
