...
public enum eDicParam implements Field {
    ...
    part("5", "5", "1", " параметр уровня", "PTYPF"),
    mixt("4", "10", "1", " параметр (смесь)", "ZNUMB"),
    name("12", "64", "1", "название параметра или его значения", "PNAME"),
    joint("5", "5", "1", " параметры соединений 0 - не влияют  1 - влияют ", "PCONN"),
    elem("5", "5", "1", " парметры составов 0 - не влияют  1 - влияют ", "PVSTA"),
    glas("5", "5", "1", " параметры стеклопакетов 0 - не влияют  1 - влияют ", "PGLAS"),
    furn("5", "5", "1", " параметры фурнитуры 0 - не влияют  1 - влияют ", "PFURN"),
    otkos("5", "5", "1", " параметры откосов 0 - не влияют  1 - влияют ", "POTKO"),
    komp("5", "5", "1", " парметры комплектов 0 - не влияют  1 - влияют ", "PKOMP"),
    text("5", "5", "1", " парметры текстур 0 - не влияют  1 - влияют ", "PCOLL"),
    prog("5", "5", "1", "системные (вшитые в систему)", "VPROG");
