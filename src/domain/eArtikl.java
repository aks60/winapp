...
public enum eArtikl implements Field {
    ...
    size_tech("8", "15", "1", "t = размер технолог.(см.размер n/t)", "ASIZV"),
    size_falz("8", "15", "1", "n - глубина до фальца (см.размер n/t)", "ASIZN"),
    size_centr("8", "15", "1", "Смещение оси от центра", "ASIZB"),
    size_f("8", "15", "1", "Размер F мм. Фурнитурный паз", "ASIZF"),
    ...
    artgrp_id("4", "10", "1", "Группа мат.ценостей", "artgrp_id"),
