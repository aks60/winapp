...
public enum eRuleclk implements Field {
    up("0", "0", "0", "Правила расчёта проектов", "RULECLK"),
    id("4", "10", "0", "Идентификатор", "id"),
    rnumb("4", "10", "1", "null", "RNUMB"),
    runic("4", "10", "1", "null", "RUNIC"),
    rname("12", "64", "1", "Название правила", "RNAME"),
    anumb("12", "32", "1", "Артикул", "ANUMB"),
    rused("5", "5", "1", "Тип материальных ценностей (502 - заполнение)", "RUSED"),
    rkoef("8", "15", "1", "Коэффициент", "RKOEF"),
    rleng("12", "96", "1", "Количество", "RLENG"),
