...
public enum eProject implements Field {
    ...
    costpric2("8", "15", "1", "Cебестоимость проекта с отходом", "PSEBE"),
    price2("8", "15", "1", "Cтоимость проекта без скидок", "PPRIC"),
    price3("8", "15", "1", "Cтоимость конструкций без скидки", "KPRIC"),   
    price4("8", "15", "1", "Cтоимость комплектации без скидки", "APRIC"),  
