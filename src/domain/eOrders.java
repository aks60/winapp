...
public enum eOrders implements Field {
    ...
    сategory("12", "32", "1", "Категория", "PPREF"),
    ...
    obj2("-4", "null", "1", "Описание объекта", "POBJL"),
    type_calc("5", "5", "1", "Тип расчтета", "PTYPE"),
    type_norm("5", "5", "1", "Учет норм отходов", "CTYPE"),
    currency_name("4", "10", "1", "Валюта название", "CNUMB"), 
    ...
    kurs2("8", "15", "1", "Курс внктренний валюты", "KURSV"),
    
    flag1("4", "10", "1", "Флаг пользователя", "PFLAG"),
    flag2("5", "5", "1", "Флаг состояния выгрузки", "PEQUP"),
    flag3("5", "5", "1", "Флаг планирования", "EWORK"),  
    flag4("5", "5", "1", "Отправка в производства", "PWORK"),    
        
    date4("93", "19", "1", "Дата отправки в производство", "WDATE"),  
    date5("93", "19", "1", "Дата регистрации проекта", "PDATE"),  
    date6("93", "19", "1", "Дата расчета", "CDATE");
