...
public enum eOrders implements Field {
    ...
    desc("8", "15", "1", "Доп. скидка", "XDESC"),
    dat1("93", "19", "1", "Дата отправки в производство", "WDATE"),
    dat2("93", "19", "1", "Доп. дата", "dat2"),   
...
//    aprcd("8", "15", "1", "стоимость комплектации со скидками", "APRCD"),
//    wprcd("8", "15", "1", "стоимость работ со скидками", "WPRCD"),
//    pprcd("8", "15", "1", "стоимость проекта со скидками", "PPRCD"),
