...
public enum eArtikls implements Field {
    ...
    name2("12", "64", "1", "у поставщика", "ANAMP"),
    ...
    length("8", "15", "1", "длина ед. поставки", "ALENG"),
    height("8", "15", "1", "ширина", "AHEIG"),
    thickn("8", "15", "1", "толщина", "AFRIC"),
    ...
    sect_perim2("8", "15", "1", "null", "APER1"),
    sect_perim3("8", "15", "1", "null", "APER2"),
    min_radius("8", "15", "1", "минимальный радиус гиба", "AMINR"),
    udesc("5", "5", "1", "ID группы скидок (см. DescLst)", "UDESC"),
    size_frez("8", "15", "1", "Фреза", "AFREZ"),
    kant("8", "15", "1", "null", "AKANT"),
    kname("12", "64", "1", "Поставщик", "KNAME"),
    ...
    sel_collor("5", "5", "1", "подбор текстур", "ACOLL"),
