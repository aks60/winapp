...
public enum ePartner implements Field {
    ...
    counter_name("12", "64", "1", "Название контрагента", "KNAME"),
    counter_categ("12", "32", "1", "Категория", "KPREF"), //Заказчик, поставщик, офис, дилер, специальный
    addr_priv("5", "5", "1", "Частное лицо", "KCHAS"), //0 - частное, 1 - организация
    addr_land("12", "64", "1", "Страна", "KCOUN"),    
    addr_city("12", "64", "1", "Город", "KTOWN"),
    addr_mail("12", "192", "1", "Почтовый адрес", "KADRP"),
    addr_phone("12", "32", "1", "Телефон", "KTELE"),
    addr_email("12", "64", "1", "E-mail", "KMAIL"),
    org_type("12", "32", "1", "Тип организации", "KTYPE"),
    org_addr("12", "192", "1", "Юридический адрес", "KADDR"),
    org_phone("12", "32", "1", "Внутренний телефон", "KVTEL"),
