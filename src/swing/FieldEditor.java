 ...
 */
public class FieldEditor extends AbstractCellEditor
    ...
    public FieldEditor(final JTextField textField) {
    ...
    public FieldEditor(final JCheckBox checkBox) {
    ...
    public FieldEditor(final JComboBox comboBox) {
        ...
        delegate = new RsEditorDelegate() {
            ...
            public boolean stopCellEditing() {
                if (comboBox.isEditable()) {
                    // Commit edited value.
                    comboBox.actionPerformed(new ActionEvent(FieldEditor.this, 0, ""));
                }
    ...
    public FieldEditor(FrameListener listener, JButton editorButton) {
    ...
    public static void initCellEditor(FrameListener listener, JTable table) {
        ...
        for (int index = 0; index < columnModel.getColumnCount(); index++) {
            ...
            Field field = model.getColumns()[index];
            if (field.meta().type().equals(Field.TYPE.INTsp)) {
                columnModel.getColumn(index).setCellEditor(new FieldEditor(listener, new JButton("...")));
                ...
                String str[] = {"+", "-"};
                columnModel.getColumn(index).setCellEditor(new FieldEditor(new JComboBox(str)));

            } else {
                JTextField jTextField = new JTextField();
                columnModel.getColumn(index).setCellEditor(new FieldEditor(jTextField));
            }
        }
    }
    ...
    public Component getTableCellEditorComponent(JTable table, Object value,
        ...
        if (field.meta().type().equals(Field.TYPE.DATE)) {
            delegate.setValue(App.DateToStr(value));
