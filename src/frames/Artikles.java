...
public class Artikles extends javax.swing.JFrame {
    ...
    private void loadingModel() {
        ...
        rsvArtikl = new DefFieldEditor(tab1) {
            ...
            public void load(Integer index) {
                super.load(index);
                Record artiklRec = qArtikl.get(Uti.getIndexRec(tab1));
    ...
    public void listenerSet() {
        ...
        listenerColor = (record) -> {
            if (tab2.getBorder() != null) {
                if (eGroups.values().length == record.size()) {
                    qArtdet.set(-1 * record.getInt(eGroups.id), Uti.getIndexRec(tab2), eArtdet.color_fk);

                } else if (eColor.values().length == record.size()) {
                    qArtdet.set(record.getInt(eColor.id), Uti.getIndexRec(tab2), eArtdet.color_fk);
                }
        ...
        listenerUnit = (record) -> {
            Uti.listenerEnums(record, tab1, eArtikl.unit, tab1, tab2);
        };
    ...
    private void initComponents() {
        ...
        tree.setFont(frames.Uti.getFont(0,0));
        ...
        tab1.setFont(frames.Uti.getFont(0,0));
        ...
        lab21.setFont(frames.Uti.getFont(0,0));
        ...
        labl17.setFont(frames.Uti.getFont(0,0));
        ...
        txt5.setFont(frames.Uti.getFont(0,0));
        ...
        txt7.setFont(frames.Uti.getFont(0,0));
        ...
        txt17.setFont(frames.Uti.getFont(0,0));
        ...
        lab22.setFont(frames.Uti.getFont(0,0));
        ...
        lab26.setFont(frames.Uti.getFont(0,0));
        ...
        lab52.setFont(frames.Uti.getFont(0,0));
        lab52.setText("Подставщик");
        ...
        txt25.setFont(frames.Uti.getFont(0,0));
        ...
        txt24.setFont(frames.Uti.getFont(0,0));
        ...
        lab54.setFont(frames.Uti.getFont(0,0));
        lab54.setText("Длина");
        ...
        lab55.setFont(frames.Uti.getFont(0,0));
        ...
        lab56.setFont(frames.Uti.getFont(0,0));
        ...
        lab49.setFont(frames.Uti.getFont(0,0));
        ...
        txt32.setFont(frames.Uti.getFont(0,0));
        ...
        txt33.setFont(frames.Uti.getFont(0,0));
        ...
        lab50.setFont(frames.Uti.getFont(0,0));
        ...
        txt40.setFont(frames.Uti.getFont(0,0));
        ...
        lab51.setFont(frames.Uti.getFont(0,0));
        ...
        tab2.setFont(frames.Uti.getFont(0,0));
    ...
    private void btnInsert(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsert
        if (tab1.getBorder() != null) {
            ...
            if (node != null && node.isLeaf()) {
                ...
                Uti.insertRecord(tab1, eArtikl.up, (record) -> {
            ...
            if (index != -1) {
                ...
                artdetRec.setNo(eArtdet.id, Conn.instanc().genId(eArtdet.up));
                artdetRec.setNo(eArtdet.artikl_id, artiklRec.get(eArtikl.id));
                qArtdet.add(artdetRec);
                ((DefaultTableModel) tab2.getModel()).fireTableDataChanged();
                Uti.scrollRectToRow(tab2.getSelectedRow() - 1, tab2);
            }
        }
    ...
    private void mousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mousePressed
        Uti.updateBorderAndSql((JTable) evt.getSource(), Arrays.asList(tab1, tab2));
...
// </editor-fold> 
    ...
    private void initElements() {
        ...
        Arrays.asList(btnIns, btnDel, btnRef).forEach(b -> b.addActionListener(l -> Uti.stopCellEditing(tab1, tab2)));
        ...
        scrTree.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0),
                "Типы артикулов", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, frames.Uti.getFont(0, 0)));
        scr1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0),
                "Свойства артикулов", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, frames.Uti.getFont(0, 0)));
        scr2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0),
                "Текстура артикулов", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, frames.Uti.getFont(0, 0)));
