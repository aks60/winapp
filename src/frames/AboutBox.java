...
public class AboutBox extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labTitle.setFont(Uti5.getFont(0, 1));
        ...
        labProjectVersion.setFont(Uti5.getFont(0, 1));
        labProjectVersion.setText("Верия программы - 1.0");

        labBase.setFont(Uti5.getFont(0, 1));
        labBase.setText("Версия базы данных - 1.0");

        labConfig.setFont(Uti5.getFont(0, 1));
        labConfig.setText("Конфигурация  - 2.0");
        ...
        btnClose.setFont(Uti5.getFont(0, 1));
