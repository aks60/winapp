...
public class Filling extends javax.swing.JFrame {
    ...
    private void listenerAdd() {
        ...
        Uti5.buttonCellEditor(tab2, 3).addActionListener(event -> {
            Record record = qGlasdet.get(Uti5.getIndexRec(tab2));
            int artikl_id = record.getInt(eElemdet.artikl_id);
            new ParColor2(this, listenerColor, artikl_id);
        });

        Uti5.buttonCellEditor(tab2, 4).addActionListener(event -> {
            Record record = qGlasdet.get(Uti5.getIndexRec(tab2));
        ...
        Uti5.buttonCellEditor(tab2, 6).addActionListener(event -> {
            Record record = qGlasdet.get(Uti5.getIndexRec(tab2));
            int colorFk = record.getInt(eGlasdet.color_fk);
        ...
        Uti5.buttonCellEditor(tab3, 1, (component) -> { //слушатель редактирование типа, вида данных и вида ячейки таблицы
            return Uti5.listenerCell(tab3, component, eGlaspar1.params_id);

        }).addActionListener(event -> {
            int grup = qGlaspar1.getAs(Uti5.getIndexRec(tab3), eGlaspar1.params_id);
            if (grup < 0) {
        ...
        Uti5.buttonCellEditor(tab4, 1, (component) -> { //слушатель редактирование типа, вида данных и вида ячейки таблицы
            return Uti5.listenerCell(tab4, component, eGlaspar2.params_id);

        }).addActionListener(event -> {
            Record record = qGlaspar2.get(Uti5.getIndexRec(tab4));
    ...
    private void listenerSet() {
        ...
        listenerArtikl = (record) -> {
            ...
            if (tab2.getBorder() != null) {
                int index = Uti5.getIndexRec(tab2);
                qGlasdet.set(record.getInt(eArtikl.id), Uti5.getIndexRec(tab2), eGlasdet.artikl_id);
                qGlasdet.table(eArtikl.up).set(record.get(eArtikl.code), Uti5.getIndexRec(tab2), eArtikl.code);
                qGlasdet.table(eArtikl.up).set(record.get(eArtikl.name), Uti5.getIndexRec(tab2), eArtikl.name);
                ((DefaultTableModel) tab2.getModel()).fireTableDataChanged();
                Uti5.setSelectedRow(tab2, index);

            } else if (tab5.getBorder() != null) {
                int index = Uti5.getIndexRec(tab5);
                qGlasprof.set(record.getInt(eArtikl.id), Uti5.getIndexRec(tab5), eGlasprof.artikl_id);
                qGlasprof.table(eArtikl.up).set(record.get(eArtikl.code), Uti5.getIndexRec(tab5), eArtikl.code);
                qGlasprof.table(eArtikl.up).set(record.get(eArtikl.name), Uti5.getIndexRec(tab5), eArtikl.name);
        ...
        listenerColor = (record) -> {
            Uti5.listenerColor(record, tab2, eGlasdet.color_fk, eGlasdet.types, tab1, tab2, tab3, tab4, tab5);
        };

        listenerColvar1 = (record) -> {
            Uti5.stopCellEditing(tab1, tab2, tab3, tab4, tab5);
            int index = Uti5.getIndexRec(tab2);
            Record glasdetRec = qGlasdet.get(Uti5.getIndexRec(tab2));
        ...
        listenerTypset = (record) -> {
            ...
            if (tab2.getBorder() != null) {
                int index = Uti5.getIndexRec(tab2);
                qGlasdet.set(record.getInt(0), Uti5.getIndexRec(tab2), eElement.typset);
                ((DefaultTableModel) tab2.getModel()).fireTableDataChanged();
                Uti5.setSelectedRow(tab2, index);
            }
        };
        ...
        listenerThicknes = (record) -> {
            ...
            if (tab2.getBorder() != null) {
                ...
                qGlasdet.set(name, Uti5.getIndexRec(tab2), eGlasdet.depth);
                ((DefaultTableModel) tab2.getModel()).fireTableDataChanged();
                Uti5.setSelectedRow(tab2, index);
            }
        };
        ...
        listenerPar1 = (record) -> {
            Uti5.listenerParam(record, tab3, eElempar1.params_id, eElempar1.text, tab1, tab2, tab3, tab4, tab5);
        };

        listenerPar2 = (record) -> {
            Uti5.listenerParam(record, tab4, eGlaspar2.params_id, eGlaspar2.text, tab1, tab2, tab3, tab4, tab5);
        };
    }
    ...
    private void btnDelete(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelete
        ...
        if (tab1.getBorder() != null) {
            if (Uti5.isDeleteRecord(this, tab2, tab3, tab5) == 0) {
    ...
    private void btnInsert(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsert
        ...
        if (tab1.getBorder() != null) {
            Uti5.insertRecord(tab1, eGlasgrp.up, (record) -> {
                record.set(eGlasgrp.gap, 0);
            });

        } else if (tab2.getBorder() != null) {
            Uti5.insertRecord(tab2, eGlasdet.up, (record) -> {
                int id = qGlasgrp.getAs(Uti5.getIndexRec(tab1), eGlasgrp.id);
            ...
            Uti5.insertRecord(tab3, eGlaspar1.up, (record) -> {
                int id = qGlasgrp.getAs(Uti5.getIndexRec(tab1), eGlasgrp.id);
                record.set(eGlaspar1.glasgrp_id, id);
            });

        } else if (tab4.getBorder() != null) {
            Uti5.insertRecord(tab4, eGlaspar2.up, (record) -> {
                int id = qGlasdet.getAs(Uti5.getIndexRec(tab2), eGlasdet.id);
                record.set(eGlaspar2.glasdet_id, id);
            });

        } else if (tab5.getBorder() != null) {
            Uti5.insertRecord(tab5, eGlasprof.up, (record) -> {
                int id = qGlasgrp.getAs(Uti5.getIndexRec(tab1), eGlasgrp.id);
    ...
    private void initElements() {
        ...
        scr1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0),
                "Список групп заполнений", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, frames.Uti5.getFont(0, 0)));
        scr2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0),
                "Детализация групп заполнений", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, frames.Uti5.getFont(0, 0)));
        ...
        scr5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0),
                "Профили в группе заполнения", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, frames.Uti5.getFont(0, 0)));
        ...
        tabb1.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                if (tabb1.getSelectedIndex() == 0) {
                    Uti5.updateBorderAndSql(tab2, Arrays.asList(tab1, tab2, tab3, tab4, tab5));
                } else if (tabb1.getSelectedIndex() == 1) {
                    Uti5.updateBorderAndSql(tab5, Arrays.asList(tab1, tab2, tab3, tab4, tab5));
                }
            }
        });
    }
