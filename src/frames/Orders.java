...
public class Orders extends javax.swing.JFrame implements ListenerReload {
    ...
    public void selectionTab1() {
        ...
        if (tab1.getSelectedRow() != -1) {
            ...
            Object data[][] = {{
                " Конструкции", projectRec.getFloat(eProject.disc2),
                df1.format(projectRec.getFloat(eProject.price2)),
                df1.format(projectRec.getFloat(eProject.cost2))},
            {" Комплектации", projectRec.getFloat(eProject.disc3),
    ...
    private void initComponents() {
        ...
        lab9.setFont(frames.UGui.getFont(0,0));
        lab9.setText("Себестоимость");
        lab9.setBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED));
        lab9.setMaximumSize(new java.awt.Dimension(2147483647, 2147483647));
            ...
            .addGroup(pan19Layout.createSequentialGroup()
                ...
                .addGroup(pan19Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pan19Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(lab3, javax.swing.GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(pan13Layout.createSequentialGroup()
                ...
                .addGroup(pan13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pan13Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txt32, javax.swing.GroupLayout.DEFAULT_SIZE, 266, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btn22))
                    .addGroup(pan13Layout.createSequentialGroup()
            ...
            .addGroup(pan15Layout.createSequentialGroup()
                ...
                .addGroup(pan15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pan15Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txt19, javax.swing.GroupLayout.DEFAULT_SIZE, 266, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btn3))
                    .addGroup(pan15Layout.createSequentialGroup()
                        ...
                        for (Record prjprodRec : qPrjprod) {
                            ...
                            if (w instanceof Wincalc) {
                                ...
                                for (Specific spc : kitList) {
                                    projectRec.set(eProject.price3, projectRec.getFloat(eProject.price3) + spc.price * spc.count);
                                    projectRec.set(eProject.cost3, projectRec.getFloat(eProject.cost3) + spc.cost2 * spc.count);
                                }
                            }
                        }
