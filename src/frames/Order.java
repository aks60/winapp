...
public class Order extends javax.swing.JFrame {
    ...
    private void loadingModel() {
        ...
        rsvPrj = new DefFieldEditor(tab1) {
            ...
            public void load(Integer index) {
                super.load(index);
                Record projectRec = qProject.get(Uti.getIndexRec(tab1));
    ...
    private void listenerAdd() {
        ...
        Uti.buttonCellEditor(tab1, 2).addActionListener(event -> {
            new DicDate(this, (obj) -> {
                ...
                Record record2 = qProject.get(Uti.getIndexRec(tab1));
        ...
        Uti.buttonCellEditor(tab1, 3).addActionListener(event -> {
            new DicDate(this, (obj) -> {
                GregorianCalendar calendar = (GregorianCalendar) obj;
                Uti.stopCellEditing(tab1);
                Record record2 = qProject.get(Uti.getIndexRec(tab1));
        ...
        Uti.buttonCellEditor(tab1, 4).addActionListener(event -> {
        ...
        Uti.buttonCellEditor(tab5, 1).addActionListener(event -> {
            ...
            ParDefault frame = new ParDefault(this, record -> {
                ...
                int index2 = Uti.getIndexRec(tab5);
                if (index != -1) {
                    ...
                    qPrjprod.execsql();
                    iwin.build(script2);
                    Uti.stopCellEditing(tab1, tab2, tab3, tab5);
                    selectionWin();
                    Uti.setSelectedRow(tab5, index2);
                }
            }, (int) grup);
        });
    }
    ...
    private void selectionTab1() {
        ...
        if (tab1.getSelectedRow() != -1) {
            ...
            lab2.setText("Заказ № " + qProject.getAs(Uti.getIndexRec(tab1), eProject.num_ord));
            int orderID = qProject.getAs(Uti.getIndexRec(tab1), eProject.id);
    ...
    private void updateScript(float selectID) {
        ...
        Record prjprodRec = qPrjprod.get(Uti.getIndexRec(tab2));
    ...
    private void initComponents() {
        ...
        pan20.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED), "Текстура элемента", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, frames.Uti.getFont(0, 0)));
        ...
        lab1.setFont(frames.Uti.getFont(0,0));
        ...
        lab3.setFont(frames.Uti.getFont(0,0));
        ...
        lab4.setFont(frames.Uti.getFont(0,0));
        ...
        lab5.setFont(frames.Uti.getFont(0,0));
        ...
        lab6.setFont(frames.Uti.getFont(0,0));
        ...
        lab7.setFont(frames.Uti.getFont(0,0));
        ...
        lab8.setFont(frames.Uti.getFont(0,0));
    ...
    private void btnDelete(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelete
        ...
        if (tab1.getBorder() != null) {
            if (Uti.isDeleteRecord(tab1, this, tab2) == 0 && tab1.getSelectedRow() != -1) {
    ...
    private void btnInsert(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsert
        ...
        if (tab1.getBorder() != null) {
            Uti.insertRecord(tab1, eProject.up, (projectRec) -> {
                projectRec.set(eProject.manager, eProfile.user);
                projectRec.set(eProject.date4, Uti.getDateCur());
            });
            ...
            new DicSyspod(this, (record) -> {
                ...
                record2.set(ePrjprod.order_id, qProject.getAs(Uti.getIndexRec(tab1), eProject.id));
    ...
    private void mousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mousePressed
        ...
        Uti.updateBorderAndSql(table, Arrays.asList(tab1, tab2, tab3, tab5));
    ...
    private void stateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_stateChanged
        ...
        if (tabb1.getSelectedIndex() == 0) {
            Uti.updateBorderAndSql(tab1, Arrays.asList(tab1, tab2, tab3, tab5));
        } else if (tabb1.getSelectedIndex() == 1) {
            Uti.updateBorderAndSql(tab2, Arrays.asList(tab1, tab2, tab3, tab5));
        } else if (tabb1.getSelectedIndex() == 2) {
            Uti.updateBorderAndSql(tab3, Arrays.asList(tab1, tab2, tab3, tab5));
        }
    ...
    private void colorToWindows(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_colorToWindows
        try {
            if (windowsNode != null) {
                ...
                int systreeID = qPrjprod.getAs(Uti.getIndexRec(tab2), ePrjprod.systree_id);
    ...
    private void btnCalcresh(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcresh
        try {
            if (Uti.getIndexRec(tab1) != -1) {
                int projectID = qProject.get(Uti.getIndexRec(tab1)).getInt(eProject.id);
                ...
                txt4.setText(Uti.df.format(total[1]));
                txt5.setText(Uti.df.format(total[2]));
                txt6.setText(Uti.df.format(total[3]));
                txt7.setText(Uti.df.format(total[0]));
            }
...
// </editor-fold> 
    ...
    private void initElements() {
        ...
        Uti.documentFilter(3, txt4, txt5, txt6, txt7, txt8);
