...
public class Kits extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnGroup1.add(rbtn1);
        rbtn1.setFont(Uti4.getFont(0, 0));
        ...
        btnGroup1.add(rbtn2);
        rbtn2.setFont(Uti4.getFont(0, 0));
        ...
        btnGroup1.add(rbtn4);
        rbtn4.setFont(Uti4.getFont(0, 0));
    ...
    private void btnDelete(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelete
        if (JOptionPane.showConfirmDialog(this, "Вы действительно хотите удалить текущую запись?", "Предупреждение",
            ...
            if (tab1.getBorder() != null) {
                Record kitsRec = qKits.get(Uti4.getIndexRec(tab1));
                kitsRec.set(eKits.up, Query.DEL);
                qKits.delete(kitsRec);
                qKits.removeRec(Uti4.getIndexRec(tab1));
                ((DefaultTableModel) tab1.getModel()).fireTableDataChanged();
                Uti4.setSelectedRow(tab1);

            } else if (tab2.getBorder() != null) {
                Record kitdetRc = qKitdet.get(Uti4.getIndexRec(tab2));
                kitdetRc.set(eColor.up, Query.DEL);
                qKitdet.delete(kitdetRc);
                qKitdet.removeRec(Uti4.getIndexRec(tab2));
                ((DefaultTableModel) tab2.getModel()).fireTableDataChanged();
                Uti4.setSelectedRow(tab2);

            } else if (tab3.getBorder() != null) {
                Record kitpar1Rec = qKitpar1.get(Uti4.getIndexRec(tab3));
                kitpar1Rec.set(eColmap.up, Query.DEL);
                qKitpar1.delete(kitpar1Rec);
                qKitpar1.removeRec(Uti4.getIndexRec(tab3));
                ((DefaultTableModel) tab3.getModel()).fireTableDataChanged();
                Uti4.setSelectedRow(tab3);
            }
        }
    ...
    private void btnInsert(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsert
        if (tab1.getBorder() != null) {
            ...
            ((DefaultTableModel) tab2.getModel()).fireTableDataChanged();
            Uti4.scrollRectToIndex(qKitdet.size() - 1, tab2);
            ...
            ((DefaultTableModel) tab3.getModel()).fireTableDataChanged();
            Uti4.scrollRectToIndex(qKitpar1.size() - 1, tab3);
        }
    }//GEN-LAST:event_btnInsert

    private void windowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_windowClosed
        Uti4.stopCellEditing(tab1, tab2, tab3);
...
// </editor-fold> 
    private void initElements() {
        btnIns.addActionListener(l -> Uti4.stopCellEditing(tab1, tab2, tab3));
        btnDel.addActionListener(l -> Uti4.stopCellEditing(tab1, tab2, tab3));
        btnRef.addActionListener(l -> Uti4.stopCellEditing(tab1, tab2, tab3));
        ...
        scr1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0),
                "Списки комплектов", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, frames.Uti4.getFont(0, 0)));
        scr2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0),
                "Детализация комплектов", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, frames.Uti4.getFont(0, 0)));
