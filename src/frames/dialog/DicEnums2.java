...
public class DicEnums2 extends javax.swing.JDialog {

    private DialogListener listener = null;
    private Enam[] enam = null;

    public DicEnums2(java.awt.Frame parent, DialogListener listenet, Enam... enam) {
        super(parent, true);
        initComponents();
        initElements();
    ...
    private void initComponents() {
        ...
        north.setPreferredSize(new java.awt.Dimension(160, 29));
        ...
        south.setPreferredSize(new java.awt.Dimension(160, 20));
