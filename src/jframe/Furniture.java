...
import jframe.dialog.DicArtikl;
import jframe.dialog.DicColvar;
import jframe.dialog.DicEnums;
import jframe.dialog.ParColor2;
import jframe.dialog.ParGrup2;
import jframe.dialog.ParGrup2b;
import jframe.dialog.ParGrup2a;
...
public class Furniture extends javax.swing.JFrame {
    ...
    private void loadingData() {
        ...
        if (owner == null) {
            qFurniture.select(eFurniture.up, "where", eFurniture.types, "= 0", "order by", eFurniture.name);
        } else {
