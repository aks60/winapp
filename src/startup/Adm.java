...
public class Adm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mn40.setFont(frames.Uti.getFont(1,1));
        ...
        lab2.setFont(frames.Uti.getFont(0,0));
        ...
        edServer.setFont(frames.Uti.getFont(0,0));
        edServer.setText("localhost");
        ...
        edPath.setFont(frames.Uti.getFont(0,0));
        ...
        edUser.setFont(frames.Uti.getFont(0,0));
        edUser.setText("sysdba");
        ...
        edPort.setFont(frames.Uti.getFont(0,0));
        edPort.setText("3050");
        ...
        edPass.setFont(frames.Uti.getFont(0,0));
        edPass.setText("masterkey");
        ...
        labPath2.setFont(frames.Uti.getFont(0,0));
        ...
        btnTest.setFont(frames.Uti.getFont(0,0));
        ...
        btnStart.setFont(frames.Uti.getFont(0,0));
