...
public class Man extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mn12.setFont(frames.Uti5.getFont(1,1));
        ...
        mn60.setFont(frames.Uti5.getFont(1,1));

        buttonBaseGroup.add(mn61);
        mn61.setFont(frames.Uti5.getFont(1,1));
        ...
        btn5.setFont(frames.Uti5.getFont(0,1));
        ...
        btn6.setFont(frames.Uti5.getFont(0,1));
        btn6.setText("Заказы");
        ...
        btn7.setFont(frames.Uti5.getFont(0,1));
        ...
        btn13.setFont(frames.Uti5.getFont(0,1));
        ...
        btn3.setFont(frames.Uti5.getFont(0,1));
        ...
        btn4.setFont(frames.Uti5.getFont(0,1));
        ...
        btn11.setFont(frames.Uti5.getFont(0,1));
        btn11.setText("Xxxxx");
        ...
        btn12.setFont(frames.Uti5.getFont(0,1));
        ...
        btn8.setFont(frames.Uti5.getFont(0,1));
        ...
        btn9.setFont(frames.Uti5.getFont(0,1));
        btn9.setText("Смета");
        ...
        btn10.setFont(frames.Uti5.getFont(0,1));
        ...
        btn14.setFont(frames.Uti5.getFont(0,1));
        ...
        btn2.setFont(frames.Uti5.getFont(0,1));
