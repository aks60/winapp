...
//            cboxDB.setVisible(false);
    ...
    private void initComponents() {
        ...
        labMes.setFont(Utils.getFont(1,1));
        ...
        labUser1.setFont(Utils.getFont(1,1));
        ...
        edHost.setFont(Utils.getFont(0,0));
        ...
        labUser2.setFont(Utils.getFont(1,1));
        ...
        edPath.setFont(Utils.getFont(0,0));
        ...
        btnFile.setFont(Utils.getFont(0,0));
        ...
        labUser3.setFont(Utils.getFont(1,1));
        labUser3.setText("Порт");
        labUser3.setAlignmentX(0.5F);

        edPort.setFont(Utils.getFont(0,0));
        ...
        labUser.setFont(Utils.getFont(1,1));
        ...
        labPass.setFont(Utils.getFont(1,1));
        ...
        edUser.setFont(Utils.getFont(0,0));
        ...
        edPass.setFont(Utils.getFont(0,0));
        ...
        btnUser.setFont(Utils.getFont(0,0));
        ...
        btnAdm.setFont(Utils.getFont(0,0));
        ...
        btnOk.setFont(Utils.getFont(0,0));
        ...
        btnClose.setFont(Utils.getFont(0,0));
